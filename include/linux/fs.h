...
extern int sysctl_prot_symlinks_create;
extern int sysctl_prot_hardlinks_create;
extern int sysctl_prot_symlinks_allow_gid;
extern int sysctl_prot_hardlinks_allow_gid;
