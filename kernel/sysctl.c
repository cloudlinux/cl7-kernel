...
extern int user_ptrace_enabled;
...
static struct ctl_table kern_table[] = {
	...
	{
		.procname	= "user_ptrace",
		.data		= &user_ptrace_enabled,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
...
static struct ctl_table fs_table[] = {
	...
	{
		.procname	= "protected_symlinks_create",
		.data		= &sysctl_prot_symlinks_create,
		.maxlen		= sizeof(int),
		.mode		= 0600,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "protected_hardlinks_create",
		.data		= &sysctl_prot_hardlinks_create,
		.maxlen		= sizeof(int),
		.mode		= 0600,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "protected_symlinks_allow_gid",
		.data		= &sysctl_prot_symlinks_allow_gid,
		.maxlen		= sizeof(int),
		.mode		= 0600,
		.proc_handler	= proc_dointvec_minmax,
	},
	{
		.procname	= "protected_hardlinks_allow_gid",
		.data		= &sysctl_prot_hardlinks_allow_gid,
		.maxlen		= sizeof(int),
		.mode		= 0600,
		.proc_handler	= proc_dointvec_minmax,
	},
